...
{
    public partial class frm_Expence_View_List : Form
    {
        public frm_Expence_View_List()
        {
            InitializeComponent();
        }
        ...
        private void cmb_Month_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Shared_Content.Bind_Grid(dgv_Expence_List, "Select Expence_ID, Date, Expence_Details, Payment_Mode from Expence_Details Where Month(Date) = " + C_Month + " And Year(Date) = " + C_Year + " ");
        }
        ...
        private void frm_Expence_View_List_Load(object sender, EventArgs e)
        {
